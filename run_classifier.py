#!/usr/bin/env python3
"""
Newsgroup Text Classification using Multinomial Naive Bayes
"""
...
def main():
    """Main function to run the newsgroup classifier"""
    print("Starting Newsgroup Text Classification")
    print("=" * 50)
    ...
    # Vectorize text using Bag of Words with Term Frequency
    print("Converting text to numerical features...")
    vectorizer = CountVectorizer(
        max_features=5000,  # Use top 5000 words as features
    ...
    for i in range(min(5, len(X_test))):
        ...
        print(f"Confidence: {max(classifier.predict_proba(X_test_vectorized[i:i+1])[0]):.3f}")
        print("-" * 30)
